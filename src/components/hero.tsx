...
export function Hero() {
  return (
    <section>
      <div className="relative rounded-lg border border-accent/20 bg-secondary/20 p-6 shadow-inner tech-border overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Main Status */}
          <div className="col-span-1 sm:col-span-2 lg:col-span-2 flex flex-col justify-between rounded-md border border-border bg-background/50 p-4">
          ...
          {/* Location Data */}
          <div className="flex flex-col justify-center space-y-2 rounded-md border border-border bg-background/50 p-4">
             <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground uppercase tracking-wider">
              <MapPin className="h-4 w-4 text-tactical-blue" />
          ...
          <div className="flex flex-col justify-center space-y-2 rounded-md border border-border bg-background/50 p-4">
            <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground uppercase tracking-wider">
              <Activity className="h-4 w-4 text-tactical-blue" />
            ...
            <div className="font-mono text-xl font-bold text-primary">
             ...
             <div className="h-1.5 w-full rounded-full bg-secondary">
              <div className="h-1.5 w-[99.9%] rounded-full bg-accent shadow-[0_0_10px_rgba(0,255,65,0.5)]"></div>
            </div>
          </div>
        
          {/* System Load Mockup */}
           <div className="col-span-1 sm:col-span-2 flex items-center justify-between rounded-md border border-border bg-background/50 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                   ...
                   <div className="font-mono text-lg font-bold text-primary">OPTIMIZED</div>
                </div>
              </div>
            ...
            {/* Terminal Mockup */}
           <div className="col-span-1 sm:col-span-2 rounded-md border border-border bg-black p-4 font-mono text-xs text-green-500 overflow-hidden">
              <div className="flex items-center gap-2 mb-2 border-b border-white/10 pb-1">
                 <Terminal className="h-3 w-3" />
                 <span className="text-muted-foreground">term_v2.0.4</span>
              </div>
              <div className="space-y-1 opacity-80">
                <p><span className="text-blue-400">root@portfolio:~$</span> init_sequence --force</p>
